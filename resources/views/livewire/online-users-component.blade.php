    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <template x-if="!loading && filtered.length === 0">
            <p class="col-span-full text-center text-gray-400">
                ...
                <span x-show="!search.trim()">No users online right now.</span>
            </p>
        </template>
        ...
        <template x-for="user in filtered" :key="user.id">
            <div class="bg-gray-800 hover:bg-gray-700 transition-colors rounded-lg overflow-hidden shadow-md">
                ...
                <div class="p-4 flex flex-col items-center text-center">
                    ...
                    <span
                        x-text="user.activity_status"
                        :class="{
                            'text-green-400': user.activity_status === 'active',
                            'text-yellow-300': user.activity_status === 'away',
                            'text-gray-400': user.activity_status === 'offline'
                        }"
